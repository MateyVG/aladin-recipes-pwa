...
import { Save, Plus, Trash2, Cookie, CheckSquare, Square, Calendar, Building2, CheckCircle, RotateCcw, FileText, AlertCircle } from 'lucide-react';
...
const ChickenMeatballProductionSheet = ({ template, config, department, restaurantId, onBack }) => {
  ...
  const hasAnyData = () => {
    ...
    return productions.some(prod => 
      prod.dateTime || prod.type || prod.quantity || prod.batchL || prod.employeeName
    );
  };
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
              <div style={{
                ...
                <Cookie style={{ width: '48px', height: '48px', color: '#195E33' }} />
              </div>
              ...
              <div>
                <h2 style={{
                  ...
                  ПРОИЗВОДСТВЕН ЛИСТ<br/>ТЕРМИЧНА ОБРАБОТКА НА ПИЛЕШКО КЮФТЕ
                </h2>
                {hasDraft && (
                  <div style={{
                    marginTop: '15px',
                  ...
                  >
                    <td style={{ padding: '12px', borderRight: '1px solid #e5e7eb' }}>
                      <input
                        ...
                        onChange={(e) => updateProduction(production.id, 'dateTime', e.target.value)}
                        style={{
                          width: '100%',
                          padding: '8px',
                    ...
                    <td style={{ padding: '12px', borderRight: '1px solid #e5e7eb' }}>
                      <input
                        ...
                        onChange={(e) => updateProduction(production.id, 'type', e.target.value)}
                    ...
                    <td style={{ padding: '12px', borderRight: '1px solid #e5e7eb' }}>
                      <input
                        ...
                        onChange={(e) => updateProduction(production.id, 'batchL', e.target.value)}
                        placeholder="L"
                        style={{
                          width: '100%',
                          padding: '8px',
